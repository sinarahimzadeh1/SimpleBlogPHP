...
<nav class="navbar navbar-expand-lg navbar-dark bg-blue ">
    ...
    <a class="navbar-brand " href="<?= url('panel') ?>">PHP blog</a>
    ...
    <section class="d-inline ">
        ...
        <?php } else { ?>
            <a class="text-decoration-none text-white" href="<?= url('auth/register.php') ?>">register</a>
            <a class="text-decoration-none text-white px-2 ">/</a>
